    ...
    <nav class="navbar">
      <div class="navbar-container">
        ...
        <div v-if="!isMobileMenuOpen" class="navbar-center">
          <button @click="currentComponent = 'ItemAdd'" class="navbar-link">Új Termék</button>
          <button @click="currentComponent = 'ItemList'" class="navbar-link">Termékek lista</button>
        </div>
