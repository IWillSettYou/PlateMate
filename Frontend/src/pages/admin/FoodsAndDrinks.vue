...
import FoodsAndDrinksList from '../../components/admin/foodsAndDrinks/FoodsAndDrinksList.vue';
import FoodsAndDrinksAdd from '../../components/admin/foodsAndDrinks/FoodsAndDrinksAdd.vue';
      ...
      <nav class="bg-white dark:bg-gray-800 shadow dark:border-gray-700 p-4">
        <div class="flex items-center">
          ...
          <div class="flex space-x-6 mx-auto">
            <button @click="currentComponent = 'FoodsAndDrinksAdd'" class="ml-auto text-white bg-slate-600 hover:bg-slate-700 font-medium rounded-lg text-m px-4 py-2">
              FoodsAndDrinks List
            </button>
            <button @click="currentComponent = 'FoodsAndDrinksList'" class="ml-auto text-white bg-slate-600 hover:bg-slate-700 font-medium rounded-lg text-m px-4 py-2">
              FoodsAndDrinks Add
            </button>
          </div>
