    ...
    <nav class="navbar">
      <div class="navbar-container">
        ...
        <div v-if="!isMobileMenuOpen" class="navbar-center">
          <button @click="currentComponent = 'UserAdd'" class="navbar-link">Új felhasználó</button>
          <button @click="currentComponent = 'UserList'" class="navbar-link">Felhasználók lista</button>
        </div>
