  ...
  <div class="home-bg">
    <nav class="navbar">
      ...
      <div v-if="isMobileMenuOpen" class="mobile-menu">
        ...
        <button @click="currentComponent = 'CategoryAdd'; isMobileMenuOpen = false" class="navbar-link">Új
          kategória</button>
        <button @click="currentComponent = 'CategoryList'; isMobileMenuOpen = false" class="navbar-link">Kategóriák
          lista</button>
      </div>
    </nav>
